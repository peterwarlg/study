...
def make_sample_her_transitions(replay_strategy, replay_k, reward_fun, ep: bool, switch: bool, using_time_reward=False):
    if ep:
        print("************************ Using ep ************************ \n")
    else:
        print("************************ Not using ep ************************\n")
    if switch:
        ...
        print("************************ Not using switch ************************\n")
    if using_time_reward:
        print('************************ Using Time Based Reward ************************\n')
    """
    ...
    # '''
    if using_time_reward:
        return _sample_her_transitions_with_ep_future

    if switch:
        if ep:
            return _sample_her_transitions_with_ep
        elif not ep:
            print("Pure HER")
            return _sample_her_transitions
        else:
    ...
    # if not ep and switch:
    #     return _sample_her_transitions
    # elif ep and switch:
    #     return _sample_her_transitions_with_ep
    # elif not ep and not switch:
    #     return _sample_her_transitions_with_ep_future
