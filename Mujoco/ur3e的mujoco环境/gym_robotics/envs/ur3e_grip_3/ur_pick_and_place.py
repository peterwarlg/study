...
from gym_robotics.envs.ur3e_grip_3 import ur_env
import gym_robotics
# 模型的绝对路径
MODEL_XML_PATH = '/home/wangzitu/miniconda3/envs/ur/lib/python3.7/site-packages/gym_robotics/envs/ur3e_grip_3/models/pick_and_place.xml'

# [0, -1.57, 1.57, -1.57, -1.57, 0.0, 0.3]

class UrPickAndPlaceEnv3(ur_env.UrEnv, utils.EzPickle):
