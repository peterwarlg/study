...
from base.mj_with_real.ddpg.HP import hp
...
class Actor(nn.Module):
    ...
    Actor (Policy) Model.
    """
    def __init__(self, dims, fc1_units=hp['hidden_size'], fc2_units=hp['hidden_size'], fc3_units=hp['hidden_size']):
        """
...
class Critic(nn.Module):
    ...
    Critic (Value) Model.
    """
    def __init__(self, dims, fcs1_units=hp['hidden_size'], fc2_units=hp['hidden_size'], fc3_units=hp['hidden_size']):
        """
        Initialize parameters and build model.
        @param dims: dict containing dimensions for input layer ('o' and 'g' ) and output layer ('a')
