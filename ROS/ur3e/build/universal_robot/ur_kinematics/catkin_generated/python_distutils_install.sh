...
echo_and_run cd "/home/wangzitu/ur3e/src/universal_robot/ur_kinematics"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/wangzitu/ur3e/src/universal_robot/ur_kinematics/setup.py" \
     \
    build --build-base "/home/wangzitu/ur3e/build/universal_robot/ur_kinematics" \
    install \
    --root="${DESTDIR-/}" \
