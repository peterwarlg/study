...
echo_and_run cd "/home/wangzitu/ur3e/src/robotiq_85/robotiq_85_driver"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/wangzitu/ur3e/src/robotiq_85/robotiq_85_driver/setup.py" \
     \
    build --build-base "/home/wangzitu/ur3e/build/robotiq_85/robotiq_85_driver" \
    install \
    --root="${DESTDIR-/}" \
